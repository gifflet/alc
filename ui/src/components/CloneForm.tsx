  ...
  return (
    ...
    >
      <input
        ...
        spellCheck={false}
        disabled={busy}
        className="rounded-panel border border-border bg-base px-2 py-1.5 font-mono text-[length:var(--ui-text-body)] text-primary outline-none focus:border-accent disabled:opacity-50"
      />
      ...
      <div className="flex gap-2">
        <input
          ...
          spellCheck={false}
          disabled={busy}
          className="min-w-0 flex-1 rounded-panel border border-border bg-base px-2 py-1.5 font-mono text-[length:var(--ui-text-body)] text-primary outline-none focus:border-accent disabled:opacity-50"
        />
        <button
          type="button"
          ...
          className="flex shrink-0 items-center gap-1.5 rounded-panel border border-border px-2.5 py-1.5 text-[length:var(--ui-text-body)] text-primary hover:bg-hover disabled:opacity-50"
        >
      ...
      <div className="flex gap-2">
        <input
          ...
          disabled={busy}
          className="min-w-0 flex-1 rounded-panel border border-border bg-base px-2 py-1.5 text-[length:var(--ui-text-body)] text-primary outline-none focus:border-accent disabled:opacity-50"
        />
        <button
          type="submit"
          disabled={!url.trim() || !parent.trim() || busy}
          className="flex shrink-0 items-center gap-1.5 rounded-panel border border-accent/60 bg-accent/10 px-3 py-1.5 text-[length:var(--ui-text-body)] text-accent hover:bg-accent/20 disabled:opacity-40"
        >
